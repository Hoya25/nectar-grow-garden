...
DROP FUNCTION IF EXISTS public.get_user_status_details;

-- Create a secure function to get user status details
-- This provides explicit access control instead of relying solely on view RLS inheritance
...
BEGIN
    ...
    -- Admins can access any user's data for management purposes
