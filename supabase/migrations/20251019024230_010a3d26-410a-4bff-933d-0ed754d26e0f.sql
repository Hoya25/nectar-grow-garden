-- Update the update_opportunity_admin function to include alliance_token_type
...
BEGIN
  ...
  SET
    ...
    alliance_token_type = COALESCE((opportunity_data->>'alliance_token_type')::text, alliance_token_type),
