...
const CollectSkillContent = () => {
  return (
    <div className="space-y-14">
      {/* How Agent Discovery Works */}
      <div>
        <h3 className="text-xl font-bold mb-8" style={{ color: "#FFFFFF", fontFamily: "Georgia, serif" }}>
          How Agent Discovery Works
        </h3>
      ...
      {/* UCP Manifest */}
      <div>
        <h3 className="text-xl font-bold mb-4" style={{ color: "#FFFFFF", fontFamily: "Georgia, serif" }}>
          UCP Manifest
        </h3>
      ...
      <div>
        <div className="flex items-center gap-3 mb-4">
          <h3 className="text-xl font-bold" style={{ color: "#FFFFFF", fontFamily: "Georgia, serif" }}>
            MCP Server
          </h3>
        ...
        <div className="space-y-3 mb-8">
          ...
          <div className="flex gap-6 text-sm flex-wrap" style={{ fontFamily: "DM Sans, sans-serif" }}>
        ...
        <h4 className="text-lg font-bold mb-4" style={{ color: "#FFFFFF", fontFamily: "Georgia, serif" }}>Available Tools</h4>
        ...
        <h4 className="text-lg font-bold mb-4" style={{ color: "#FFFFFF", fontFamily: "Georgia, serif" }}>Quick Start</h4>
...
export default CollectSkillContent;
