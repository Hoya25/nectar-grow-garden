...
export const MallSearch = ({ totalBrands, onSelect }: MallSearchProps) => {
    ...
    <div className="relative w-full max-w-2xl mx-auto">
      ...
      <div className="relative">
        ...
        <Input
          ...
          className="pl-12 pr-10 h-12 text-lg rounded-full bg-card border-2 border-border focus:border-primary"
        />
        {query && (
          <button
            onClick={() => setQuery("")}
